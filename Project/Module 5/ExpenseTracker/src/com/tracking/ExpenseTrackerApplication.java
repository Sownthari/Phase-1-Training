...
public class ExpenseTrackerApplication {
    ...
    public static void main(String[] args) {
        ...
        TransactionService transactionService = new TransactionService(transactionImpl, categoryImpl, budgetImpl);
        BudgetService budgetService = new BudgetService(budgetImpl, categoryImpl, transactionService);
